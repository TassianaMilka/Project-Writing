...
Realização descrito em português sobre um relatório de Administração de Sistemas Operacionais :

-Descrevi uma introdução sobre o começo e os seus requisitos;

-Realizei o que foi proposto sobre análise de pesquisa e instalação no virtualbox.
